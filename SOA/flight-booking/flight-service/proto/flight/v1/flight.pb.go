...
const (
	FlightStatus_SCHEDULED FlightStatus = 0
	FlightStatus_DEPARTED  FlightStatus = 1
	FlightStatus_CANCELLED FlightStatus = 2
	FlightStatus_COMPLETED FlightStatus = 3
)
...
const (
	ReservationStatus_ACTIVE   ReservationStatus = 0
	ReservationStatus_RELEASED ReservationStatus = 1
	ReservationStatus_EXPIRED  ReservationStatus = 2
)
...
type Flight struct {
	...
	Status         FlightStatus           `protobuf:"varint,10,opt,name=status,proto3,enum=flight.v1.FlightStatus" json:"status,omitempty"`
...
type SearchFlightsRequest struct {
	...
	Date          *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=date,proto3" json:"date,omitempty"` // optional
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ReserveSeatsRequest struct {
	...
	BookingId     string                 `protobuf:"bytes,3,opt,name=booking_id,json=bookingId,proto3" json:"booking_id,omitempty"` // для идемпотентности
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_flight_v1_flight_proto_rawDesc = "" +
	"\n" +
	"\x16flight/v1/flight.proto\x12\tflight.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8a\x03\n" +
	"\x06Flight\x12\x0e\n" +
	...
	"\x06status\x18\n" +
	" \x01(\x0e2\x17.flight.v1.FlightStatusR\x06status\"\x80\x01\n" +
	"\x14SearchFlightsRequest\x12\x16\n" +
	"\x06origin\x18\x01 \x01(\tR\x06origin\x12 \n" +
	"\vdestination\x18\x02 \x01(\tR\vdestination\x12.\n" +
	"\x04date\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x04date\"D\n" +
	...
	"\n" +
	"seat_count\x18\x02 \x01(\x05R\tseatCount\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x03 \x01(\tR\tbookingId\"\x16\n" +
	"\x14ReserveSeatsResponse\":\n" +
	"\x19ReleaseReservationRequest\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x01 \x01(\tR\tbookingId\"\x1c\n" +
	"\x1aReleaseReservationResponse*I\n" +
	"\fFlightStatus\x12\r\n" +
	"\tSCHEDULED\x10\x00\x12\f\n" +
	"\bDEPARTED\x10\x01\x12\r\n" +
	"\tCANCELLED\x10\x02\x12\r\n" +
	"\tCOMPLETED\x10\x03*:\n" +
	"\x11ReservationStatus\x12\n" +
	"\n" +
	"\x06ACTIVE\x10\x00\x12\f\n" +
	"\bRELEASED\x10\x01\x12\v\n" +
	"\aEXPIRED\x10\x022\xd4\x02\n" +
	"\rFlightService\x12R\n" +
	...
	"\x12ReleaseReservation\x12$.flight.v1.ReleaseReservationRequest\x1a%.flight.v1.ReleaseReservationResponseB3Z1github.com/Tekha03/flight-booking/proto/flight/v1b\x06proto3"
...
var file_flight_v1_flight_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_flight_v1_flight_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_flight_v1_flight_proto_depIdxs = []int32{
	...
	10, // 3: flight.v1.SearchFlightsRequest.date:type_name -> google.protobuf.Timestamp
	2,  // 4: flight.v1.SearchFlightsResponse.flights:type_name -> flight.v1.Flight
	3,  // 5: flight.v1.FlightService.SearchFlights:input_type -> flight.v1.SearchFlightsRequest
	5,  // 6: flight.v1.FlightService.GetFlight:input_type -> flight.v1.GetFlightRequest
	6,  // 7: flight.v1.FlightService.ReserveSeats:input_type -> flight.v1.ReserveSeatsRequest
	8,  // 8: flight.v1.FlightService.ReleaseReservation:input_type -> flight.v1.ReleaseReservationRequest
	4,  // 9: flight.v1.FlightService.SearchFlights:output_type -> flight.v1.SearchFlightsResponse
	2,  // 10: flight.v1.FlightService.GetFlight:output_type -> flight.v1.Flight
	7,  // 11: flight.v1.FlightService.ReserveSeats:output_type -> flight.v1.ReserveSeatsResponse
	9,  // 12: flight.v1.FlightService.ReleaseReservation:output_type -> flight.v1.ReleaseReservationResponse
